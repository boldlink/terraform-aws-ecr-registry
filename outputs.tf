// Output the scan type from the scanning configuration (if defined)
...
// Output the pull-through cache rule details (if enabled)
...
// Output the replication configuration (if defined)
...
// Output the created repository's name (if a repository is created)
...
// Output the created repository's ARN (if a repository is created)
...
// Output the created repository's URL (if a repository is created)
...
// Output the image tag mutability setting (if a repository is created)
...
// Output the encryption configuration of the repository (if a repository is created)
...
// Output the repository-level policy (if provided and repository is created)
